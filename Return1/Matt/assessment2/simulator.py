...
if __name__ == "__main__":
    ...
    parser.add_argument('-i', "-gt", "-input", metavar='i', type=str , default="/Users/mattarnold/Masters/Return1/Matt/assessment2/xHTlB.jpg", help='ground truth image (optional)')
